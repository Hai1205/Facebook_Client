...
import { REJECTION_REASON_CHOICE, CHOICE } from "@/utils/choices";
              ...
              <Dialog.Panel className="w-full max-w-2xl transform overflow-hidden rounded-2xl bg-[#121212] p-6 text-left align-middle shadow-xl transition-all">
                  ...
                  <div className="py-4">
                    <div className="flex items-center gap-4 mb-4">
                      <Avatar className="h-12 w-12">
                        <AvatarImage
                          src={report.user?.avatarPhotoUrl}
                          alt={report.user?.fullName}
                        />
                        <AvatarFallback>
                          {report.user?.fullName?.substring(0, 2)}
                        </AvatarFallback>
                      </Avatar>
                      <div>
                    ...
                    <div className="space-y-4">
                      <div className="grid gap-2">
                        ...
                        <Select
                          onValueChange={(value) =>
                            handleReportChange("rejectionReason", value)
                          }
                        >
                          ...
                          <SelectContent>
                            {REJECTION_REASON_CHOICE.map((item: CHOICE) => (
                ...
                <div className="flex justify-between sm:justify-between p-4">
                  ...
                  <Button
                    ...
                    disabled={!reportData.rejectionReason || isResponding}
                  >
                    {isResponding ? (
                      <>
                        <LoadingSpinner />

...
export function MessageItem({
  ...
  return (
    <div className={`mb-3 ${sender === "me" ? "text-right" : "text-left"}`}>
      <div className={`relative ${sender === "me" ? "pr-6" : "pl-6"}`}>
        <div
          className={`absolute top-0 ${sender === "me" ? "right-0" : "left-0"}`}
        >
        ...
        >
          ...
          >
            ...
            {sender === "me" && (
              <>
                {status === MESSAGE_STATUS_ENUM.SENDING && !isChatBot && (
